...
if __name__ == "__main__":
    ...
    query = "Xu hướng kiến trúc LLM hiện nay là gì (mới nhất hiện nay)?"
    ...
    # )
    # query = "Các kỹ thuật distillation trong ML/DL"
    # query = "Các mô hình distillation ML/DL nổi bật từ trước đến nay"
    run_agent(query)
    # test()
